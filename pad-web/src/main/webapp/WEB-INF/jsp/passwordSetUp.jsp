...
<body ng-controller="passwordSetUpController" ng-cloak ng-init="init('${isTestEnvironment}')">
        ...
        <div ng-if="passwdSetUpSuccess">
            <div class="alert alert-success">
                ...
                <div style="padding-top: 20px;">
                    {{translation.KEY_SCREEN_LOGIN_SYSTEM_NEW_PASSWORD_MESSAGE}}. <br> <br> <a class="alert-link" href="login.htm?${loginType}">{{translation.KEY_SCREEN_CLICK_HERE_LOGIN_LABEL}}!</a>
                </div>
            </div>
        </div>
