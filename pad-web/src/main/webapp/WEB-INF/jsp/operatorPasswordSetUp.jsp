...
<body ng-controller="operatorPasswordSetUpController" ng-cloak ng-init="init('${isTestEnvironment}')">

    <%@ include file="../../app/views/offlineNavbar.jsp"%>

    <h3 class="text-center">{{translation.KEY_SCREEN_SETUP_PASSWORD_LABEL}}</h3>
    ...
    <div class="container-fluid pad-center">
        ...
        <div ng-hide="passwdSetUpSuccess">
            <form name="dataForm" autocomplete="off" novalidate>
                <div class="form-group">
                    <label for="">{{translation.KEY_SCREEN_USERNAME_LABEL}}: </label> {{input1}}
                </div>
                <div class="form-group">
                    <label for="smsVerificationCode">{{translation.KEY_SCREEN_VERIFICATION_CODE_LABEL}}</label>
                    <input type="text" class="form-control" name="smsVerificationCode" ng-model="formData.smsVerificationCode" ng-minlength="5" ng-maxlength="5" maxlength="5"
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" name="password" placeholder="{{translation.KEY_SCREEN_PASSWORD_LABEL}}" ng-model="formData.password"
                        ng-pattern="passwordRegexp" ng-maxlength="32" maxlength="32" required>
                </div>
                <div class="form-group">
                ...
                <div ng-if="passwordSetUpErrorResponse !== ''">
                    <div class="alert alert-danger" role="alert">
                        ...
                        {{passwordSetUpErrorResponse}}
                    </div>
                </div>

                <button type="button" class="btn btn-primary btn-block" ng-disabled="passwordSetUpSubmitButtonDisabled || passwdSetUpSuccess" ng-click="passwordSetUp()">{{translation.KEY_SCREEN_SETUP_PASSWORD_LABEL}}</button>
        ...
        <div ng-if="passwdSetUpSuccess">
            <div class="alert alert-success">
                <h4>{{translation.KEY_SCREEN_PASSWORD_SETUP_MESSAGE}}!</h4>
                <div style="padding-top: 20px;">
                    {{translation.KEY_SCREEN_LOGIN_SYSTEM_NEW_PASSWORD_MESSAGE}}. <br> <br> <a class="alert-link" href="login.htm?op">{{translation.KEY_SCREEN_CLICK_HERE_LOGIN_LABEL}}!</a>
                </div>
            </div>
        </div>
